...
ErrorCode anoncreds_create_credential_offer(FfiStr schema_id, ObjectHandle cred_def,
...
ErrorCode anoncreds_create_revocation_registry(
...
ErrorCode anoncreds_create_schema(FfiStr origin_did, FfiStr schema_name,
                              FfiStr schema_version, FfiStrList attr_names,
                              int64_t seq_no, ObjectHandle *result_p);

ErrorCode anoncreds_credential_definition_get_attribute(ObjectHandle handle,
                                                    FfiStr name,
                                                    const char **result_p);
...
ErrorCode anoncreds_schema_get_attribute(ObjectHandle handle, FfiStr name,
                                     const char **result_p);

ErrorCode anoncreds_set_default_logger(void);

ErrorCode anoncreds_update_revocation_registry(
