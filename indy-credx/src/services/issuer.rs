...
use indy_data_types::{
    anoncreds::{
        cred_def::{
            CredentialDefinition, CredentialDefinitionData, CredentialDefinitionPrivate,
            CredentialDefinitionV1, CredentialKeyCorrectnessProof, SignatureType,
        },
        ...
        nonce::Nonce,
        rev_reg::{
            RevocationRegistry, RevocationRegistryDelta, RevocationRegistryDeltaV1,
...
use indy_utils::{did::DidValue, Qualifiable, Validatable};
...
impl Issuer {
    ...
    pub fn new_credential_definition(
        ...
        trace!(
            ...
            cred_def, secret!(&cred_def_private), cred_key_proof
        );
