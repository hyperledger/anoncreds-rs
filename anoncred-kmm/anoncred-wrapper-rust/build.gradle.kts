...
val crateDir = projectDir
val crateTargetDir = projectDir.resolve("target")
val crateTargetLibDir = crateTargetDir.resolve("debug")
val pathToCopyBindingInto = rootDir.resolve("anoncreds-kmp").resolve("build").resolve("generated")
...
val buildAnoncredsLib by tasks.register<Exec>("buildAnoncredsLib") {
    ...
    workingDir = rootDir
    inputs.files(rootDir.resolve("Cargo.toml"))
    outputs.files(fileTree(rootDir.resolve("target")))
...
val copyGeneratedBinaryForMacOSX8664 by tasks.register<Copy>("copyGeneratedBinaryForMacOSX86_64") {
    ...
    into(rootDir.resolve("anoncred-kmm").resolve("anoncreds-kmp").resolve("build").resolve("generatedResources").resolve("jvm").resolve("main").resolve("darwin-x86-64"))
...
val copyGeneratedBinaryForMacOSArch64 by tasks.register<Copy>("copyGeneratedBinaryForMacOSArch64") {
    ...
    into(rootDir.resolve("anoncred-kmm").resolve("anoncreds-kmp").resolve("build").resolve("generatedResources").resolve("jvm").resolve("main").resolve("darwin-aarch64"))
...
val copyGeneratedBinaryForLinuxX8664 by tasks.register<Copy>("copyGeneratedBinaryForLinuxX86_64") {
    ...
    into(rootDir.resolve("anoncred-kmm").resolve("anoncreds-kmp").resolve("build").resolve("generatedResources").resolve("jvm").resolve("main").resolve("linux-x86-64"))
...
val copyGeneratedBinaryForLinuxArch64 by tasks.register<Copy>("copyGeneratedBinaryForLinuxArch64") {
    ...
    into(rootDir.resolve("anoncred-kmm").resolve("anoncreds-kmp").resolve("build").resolve("generatedResources").resolve("jvm").resolve("main").resolve("linux-aarch64"))
...
val copyGeneratedBinaryForiOS by tasks.register<Copy>("copyGeneratedBinaryForiOS") {
    ...
    into(rootDir.resolve("anoncred-kmm").resolve("anoncreds-kmp").resolve("build").resolve("processedResources").resolve("binaries").resolve("ios"))
...
val copyGeneratedBinaryForAndroidX8664 by tasks.register<Copy>("copyGeneratedBinaryForAndroidX86_64") {
    ...
    into(rootDir.resolve("anoncred-kmm").resolve("anoncreds-kmp").resolve("build").resolve("generatedResources").resolve("android").resolve("main").resolve("jniLibs").resolve("x86-64"))
...
val copyGeneratedBinaryForAndroidArch64 by tasks.register<Copy>("copyGeneratedBinaryForAndroidArch64") {
    ...
    into(rootDir.resolve("anoncred-kmm").resolve("anoncreds-kmp").resolve("build").resolve("generatedResources").resolve("android").resolve("main").resolve("jniLibs").resolve("arm64-v8a"))
...
val copyGeneratedBinaryForAndroidI686 by tasks.register<Copy>("copyGeneratedBinaryForAndroidI686") {
    ...
    into(rootDir.resolve("anoncred-kmm").resolve("anoncreds-kmp").resolve("build").resolve("generatedResources").resolve("android").resolve("main").resolve("jniLibs").resolve("x86"))
...
val copyGeneratedBinaryForAndroidArmv7a by tasks.register<Copy>("copyGeneratedBinaryForAndroidArmv7a") {
    ...
    into(rootDir.resolve("anoncred-kmm").resolve("anoncreds-kmp").resolve("build").resolve("generatedResources").resolve("android").resolve("main").resolve("jniLibs").resolve("armeabi-v7a"))
...
val copyBindings by tasks.register<Copy>("copyBindings") {
    ...
    into(rootDir.resolve("anoncred-kmm").resolve("anoncreds-kmp").resolve("build").resolve("generated"))
...
val copyAnoncredsBinariesToProcessedResources by tasks.register<Copy>("copyAnoncredsBinariesToProcessedResources") {
    ...
    include("*.so", "*.a", "*.d", "*.dylib")
    from(rootDir.resolve("rust-libs").resolve("anoncreds-rs").resolve("target").resolve("release"))
    into(rootDir.resolve("anoncred-kmm").resolve("anoncreds-kmp").resolve("build").resolve("generatedResources").resolve("jvm").resolve("main"))
...
val deleteRustSrcFiles by tasks.register<Delete>("deleteRustSrcFiles") {
    group = "rust"
    project.delete(
        fileTree(rootDir.resolve("anoncred-kmm").resolve("anoncred-wrapper-rust").resolve("src"))
    )
}
...
val moveRustSrcFiles by tasks.register<Copy>("moveRustSrcFiles") {
    ...
    duplicatesStrategy = DuplicatesStrategy.INCLUDE
    from(
        fileTree(rootDir.resolve("uniffi").resolve("src"))
    )
